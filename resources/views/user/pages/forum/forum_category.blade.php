            ...
            <div class="inner-wrapper">
                ...
                <div class="inner-main">
                    ...
                    <div class="inner-main-header">
                        <form action="{{url("/forum/category",["category"=>$category->slug])}}" method="get">
                        ...
                        <div style="margin: 15px 0;padding: 20px 0;border-top: 2px solid #b9b9b9">
                            ...
                            <ul class="list-category">
                                @foreach($categories as $item)
                                    @php
                                        $post_categories = \App\Models\Post::where("category_id",$item->id)->where("is_approved",1)->get();@endphp
