...
//    'name' => 'Videos',
//    'adapter' => 'local',
//    'baseUrl' => '/ckfinder/userfiles/videos/',
//    'chmodFiles' => 0777,
//    'chmodFolders' => 0755,
//    'filesystemEncoding' => 'UTF-8',
//];
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => '7z,,jfif,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'videos',
    'maxSize'           => 0,
    'allowedExtensions' => 'avi,mov,mp4,webm,wmv',
    'deniedExtensions'  => '',
    'backend'           => 'default',
);

//$config['allowedContent'] = 'video[*]{*}(*)';
